...
Update History:
     ...
     V1.4 : Main document update
      ...
      V1.6 : Main document change description:
            1. Add Deep N Well Characterization Report and model in section 7.2.
            2. Change Vg start.
            3. Included Nwell/Pwell diode I-V model in MOS varactor model in section 7.5. Updated MOS varactor equivalent circuit in section 7.5.3.
            4. Included Junction diode I-V model in junction varactor model in section 7.6.
            5. Updated the sheet resistance and resistor model correlated to mixed signal resistor model in section 7.8.
            6. Updated thick top metal (m6) resistor value in section 7.8.4.
            Attachment change description:
            1. Add GDS file for Deep N Well characterization structure as following:DNW18_W10Ld5N8.gds, DNW33_W10L1N8.gds.
            2. Updated res_rf.def file for resistor model.
            3. Updated resistor and MOS/Junction Varactor correlative model card except for varactor ELDO format model card. ELDO model card for Vractor will release in next version. 
            4. Included top metal resistor (m6) model card in Hspice/Spectre/Eldo format.

Files:

      ms018_rf_v1p6_readme_spe.txt         .... This file!
      ms018_rf_v1p6_spe.lib                .... Corner values for MOSFETs, resistors and MIM
      ms018_rf_v1p6_mos_spe.ckt            .... Subcircuit model of MOSFETs
      ms018_rf_v1p6_ind_spe.ckt            .... Subcircuit model of inductor 
      ms018_rf_v1p6_var_spe.ckt            .... Subcircuit model of varactors
      ms018_rf_v1p6_res_spe.ckt            .... Subcircuit model of resistors
      ms018_rf_v1p6_m6_res_spe.mdl         ....  model of m6 resistors
      ms018_rf_v1p6_mim_spe.ckt            .... Subcircuit model of MIM 
      ...
      DNW18_W10LD5N8.gds                   .... GDSII file for 1.8V DNW MOS W/L/N=10/0.5/8
      DNW33_W10L1N8.gds                    .... GDSII file for 3.3V DNW MOS W/L/N=10/1/8
